<?php
	...
	$cariYgLumSelesai = mysqli_query($con,"SELECT nomorInduk, nomorPeserta, jurusan, acakSoal$keHari, tmpAnswer$keHari FROM absensiharitespeserta WHERE (jurusan='IPC' OR jurusan='$jur') AND acakSoal$keHari!='' AND tmpAnswer$keHari!=''");
