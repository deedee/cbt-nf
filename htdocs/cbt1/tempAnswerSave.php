<?php
	...
	mysqli_query($con, "UPDATE absensiharitespeserta SET loginKey=0, curTimer=$cTime, tmpAnswer$haKe='$jaSo' WHERE nomorInduk='$noInd' AND nomorPeserta='$noPes' AND hariKe$haKe='0' LIMIT 1");
